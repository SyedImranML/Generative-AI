...
# Streamlit App Title
st.title("Chat with Images/Graphs/Invoices")
...
# Add "Powered By UMC Data Fusion ⚙️" at the bottom in a dark blue box
st.markdown(
    """
    <style>
    .powered-by {
    ...
    <div class="powered-by">Powered By UMC Data Fusion ⚙️</div>
    """,
